...
},{"./cjs/react-dom.production.min.js":"i17t"}],"ED/T":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"nUiQ"}],"R7zu":[function(require,module,exports) {
...
},{"axios":"dZBD"}],"KB0V":[function(require,module,exports) {
module.exports = [
  "barnyard",
  "bird",
  "cat",
...
},{}],"OpLS":[function(require,module,exports) {
...
},{"./impl":"R7zu","./animals":"KB0V"}],"pmSn":[function(require,module,exports) {
"use strict";
...
},{"react":"1n8/"}],"/sXU":[function(require,module,exports) {
/**
...
},{"./factoryWithThrowingShims":"wVGV"}],"2gTp":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
module.exports = exports['default'];
},{"react":"1n8/","./implementation":"NmbE"}],"nkXc":[function(require,module,exports) {
"use strict";
  ...
  for (var i = 0, l = ranked.length; i < l; i++) {
    ...
    for (; index < max; index++) {
      ...
      if (dynamicMatch && !isRootUri) {
        ...
        !matchIsNotReserved ? "production" !== "production" ? (0, _invariant.default)(false, "<Router> dynamic segment \"" + dynamicMatch[1] + "\" is a reserved name. Please use a different name in path \"" + route.path + "\".") : (0, _invariant.default)(false) : void 0;
...
},{"invariant":"2gTp"}],"9+jT":[function(require,module,exports) {
"use strict";
...
"production" !== "production" ? LocationProvider.propTypes = {
...
"production" !== "production" ? Redirect.propTypes = {
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    !(element.props.path || element.props.default || element.type === Redirect) ? "production" !== "production" ? (0, _invariant.default)(false, "<Router>: Children of <Router> must have a `path` or `default` prop, or be a `<Redirect>`. None found on element type `" + element.type + "`") : (0, _invariant.default)(false) : void 0;
    !!(element.type === Redirect && (!element.props.from || !element.props.to)) ? "production" !== "production" ? (0, _invariant.default)(false, "<Redirect from=\"" + element.props.from + " to=\"" + element.props.to + "\"/> requires both \"from\" and \"to\" props when inside a <Router>.") : (0, _invariant.default)(false) : void 0;
    !!(element.type === Redirect && !(0, _utils.validateRedirect)(element.props.from, element.props.to)) ? "production" !== "production" ? (0, _invariant.default)(false, "<Redirect from=\"" + element.props.from + " to=\"" + element.props.to + "\"/> has mismatched dynamic segments, ensure both paths have the exact same dynamic segments.") : (0, _invariant.default)(false) : void 0;
...
},{"react":"1n8/","warning":"/sXU","prop-types":"5D9O","invariant":"2gTp","create-react-context":"EFM4","react-lifecycles-compat":"nkXc","./lib/utils":"gj0I","./lib/history":"9+jT"}],"EcQx":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"react":"1n8/","./Pet":"EcQx"}],"DIxv":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"react":"1n8/"}],"45oL":[function(require,module,exports) {
"use strict";
...
const SearchParams = () => {
  ...
  (0, _react.useEffect)(() => {
    ...
    _pet.default.breeds(animal).then((_ref2) => {
      ...
      const breedStrings = breeds.map((_ref3) => {
        let name = _ref3.name;
        return name;
      });
  ...
  }, "Find")), _react.default.createElement(_Results.default, {
    pets: pets
  }));
};
...
exports.default = _default;
},{"react":"1n8/","@frontendmasters/pet":"OpLS","./useDropdown":"pmSn","./Results":"tKTj","./ThemeContext":"DIxv"}],"a8+i":[function(require,module,exports) {
"use strict";
...
class Carousel extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "handldIndexClick", evt => {
      this.setState({
  ...
  render() {
    ...
    }, photos.map((photo, idx) => // eslint-disable-next-line
    _react.default.createElement("img", {
      key: photo,
...
exports.default = _default;
},{"react":"1n8/"}],"Vlsp":[function(require,module,exports) {
"use strict";
  ...
  render() {
    ...
    if (this.state.hasError) {
      return _react.default.createElement("h1", null, "There was an error with this listing.", " ", _react.default.createElement(_router.Link, {
        to: "/adopt-me-react/"
      }, "Click here to return to home page"), ", or wait for five seconds.");
    }
...
exports.default = _default;
},{"react":"1n8/","@reach/router":"VJZj"}],"+Dtd":[function(require,module,exports) {
"use strict";
...
class Details extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "adopt", () => {
      (0, _router.navigate)(this.state.url);
    });
  }
  ...
  render() {
    ...
    }), _react.default.createElement("p", null, description), this.state.showModal ? _react.default.createElement(_Modal.default, null, _react.default.createElement("div", null, _react.default.createElement("h1", null, "Would you like to adopt ", name, "?"), _react.default.createElement("div", {
      className: "buttons"
...
},{"react":"1n8/","@frontendmasters/pet":"OpLS","./Carousel":"a8+i","./ErrorBoundary":"Vlsp","./ThemeContext":"DIxv","@reach/router":"VJZj","./Modal":"+Dtd"}],"lY9v":[function(require,module,exports) {
"use strict";
...
const App = () => {
  ...
  return _react.default.createElement(_ThemeContext.default.Provider, {
    ...
    path: "/adopt-me-react/details/:id"
  }))));
};

(0, _reactDom.render)(_react.default.createElement(App), document.getElementById("root"));
},{"react":"1n8/","react-dom":"NKHc","./SearchParams":"45oL","@reach/router":"VJZj","./Details":"XGSj","./ThemeContext":"DIxv"}]},{},["lY9v"], null)
//# sourceMappingURL=/adopt-me-react/App.046db678.js.map